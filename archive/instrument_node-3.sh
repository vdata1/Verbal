...
# List of test/fuzzer commands (relative to Node build dir)
TEST_COMMANDS=(
    "./node path/to/test1.js"
    "./node path/to/test2.js --flag"
    # "./node path/to/fuzzer.js"
)
...
for cmd in "${TEST_COMMANDS[@]}"; do
    echo "    → $cmd"
    NODE_V8_COVERAGE="$WORKDIR/v8_js_coverage" bash -c "$cmd"
done
